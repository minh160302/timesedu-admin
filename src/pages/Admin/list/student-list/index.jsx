...
import { getStudentProfileById } from "./actions"
...
const handleNewClick = () => {
  history.push("/admin/form/student")
}
      ...
      render: (text, record) => (
        <Space size="middle">
          <a onClick={() => {
            ...
            props.getStudentProfileById({ id: record.id })
            history.push(`/admin/profile/student/${record.id}`)
          }}>View details</a>
        </Space>
      ),
    },
